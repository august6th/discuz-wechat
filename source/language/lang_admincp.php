...
',
    ...
    'setting_credits_trans1' => '主题买卖使用的积分',
    'setting_credits_trans1_comment' => '主题买卖使用的积分',

    //二次开发debug
    'setting_credits_trans13' => '附件买卖使用的积分',
    'setting_credits_trans13_comment' => '附件买卖使用的积分',
...
<li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。</li><li>您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。</li><li>财付通服务热线：0755-83762288-2(全天24小时服务热线)</li>',
    ...
    //二次开发 人才供求版块招聘求职
    'koueirec_userdata' => '发布人',
    'koueirec_compname' => '公司名称',
    'koueirec_compphone' => '公司电话',
    'koeuirec_pic' => '营业执照',
    'kouei_rec_title' => '招聘数据管理',
    'kouei_rec_search' => '招聘数据搜索',
    'kouei_rec_export_tips' => '<li>招聘数据只显示部分重要数据，更多详情请搜索后点击查看，进入帖子查询即可。</li><li>导出招聘数据信息最多支持 10000 条数据。导出的 .xls 文件可用 EXCEL 打开。</li>',
    'rec_search_time' => '招聘发表时间',
    'rec_search_time_comment' => '格式 yyyy-mm-dd，不限制请输入 0',
    'koueirec_search_result' => '共搜索到<strong> {reccount} </strong>名符合条件的数据',
    'koueirec_search_deleteall' => '删除搜索到的全部<strong> {reccount} </strong>条数据',
    'koueirec_delete_thread' => '同时删除对应的帖子',

    // 论坛小导航
    'kouei_navigation_title' => '论坛小导航',
    'kouei_navigation_base_tips' => '查看你设置的标签，以及对应的版块 id ',
    'kouei_navigation_add_tips' => '请根据对应内容，添加你的标签信息',
    'kouei_navigation_modify_tips' => '修改您的导航内容',
    'kouei_navigation_block_id' => '导航 id',
    'kouei_navigation_block_name' => '导航名',
    'block_name_comment' => '导航名最好不超过 10 个字',
    'kouei_navigation_block_item' => '导航下的版块 id',
    'block_item_comment' => "可填写多个板块 id ，请用英文逗号 ',' 将 id 隔开",
    'kouei_navigation_store_error_empty' => '您填写的信息不能为空，或者您还没有设置分类',
    'kouei_navigation_too_long' => '您提交的内容过长，如有疑问，请联系技术人员',
    'kouei_navigation_type_error' => '您提交的类型有误，请重新填写。',
    'unknow_error' => '失败了，并产生未知错误，请联系技术人员排查。',
    'create_block_success' => '成功创建',
    ...
    'nothing_modify' => '请先选择您要修改的内容',
    'kouei_nav_recommend' => '热门推荐',
    'kouei_recommend_tips' => '设置你推荐的主题的 tid 值，最好在 3 ~ 6 个主题之间，该功能直接将数据插入缓存中，需要更新缓存才能查看。',
    'kouei_block_clean' => '成功删除<strong> {delete_blocks} </strong>个导航，并删除了<strong> {delete_blockitems} </strong>个关注！',
    'kouei_adv' => '是否开启广告',
    'kouei_help_fid' => '求助版块 id',
    'kouei_help_fid_explain' => '设置前台“我要求助”的指定求助版块',
    'kouei_adv_img' => '广告图片名',
    'kouei_adv_img_explain' => '设置小导航广告的图片名，根据你上传到服务器的图片名称，上传位置 static/image/adv/ 。',
    'kouei_adv_link' => '广告链接',
    'kouei_adv_link_explain' => '设置广告的链接地址。',
    'kouei_push_adv_link' => '投放广告链接',
    'kouei_push_adv_link_explain' => '即设置其他商户，在论坛上投放广告的入口',
    'kouei_navigation_sort' => '选择分类',
    'block_sort' => '设置分类',
    ...
    'kouei_navsort_base_tips' => '查看你设置的标签分类',
    'kouei_navsort_add_tips' => '添加标签分类',
    'kouei_navsort_modify_tips' => '修改您的标签分类',
    'kouei_navsort_order_id' => '分类优先级',
    'kouei_navsort_sort_name' => '分类名称',
    'order_id_comment' => '设置您的分类优先级，这将影响到您分类排序的顺序。',
    'sort_name_comment' => '设置您的分类名称, 尽量不要超过四个字',
    'kouei_navsort_count' => '共有<strong> {sort_count} </strong>个分类',
    'kouei_navsort_id' => '分类id',
    'kouei_navsort_name' => '分类名称',
    'kouei_sort_clean' => '成功删除<strong> {delete_sorts} </strong>个分类，并影响了<strong> {update_blocks} </strong>个导航！',

    //扩展区域语言包
    'kouei_mobile_validate' => '发帖是否验证手机',
    'kouei_extra_tips' => '用于设置一些附加的后台功能',


    'koueijob_userdata' => '发布人',
    'koueijob_name' => '姓名',
    'koueijob_birthday' => '出生年月',
    'koueijob_gender' => '性别',
    'koueijob_edu' => '学历',
    'koueijob_exp' => '工作经验',
    'koueijob_nature' => '工作性质',
    'koueijob_pos' => '期望职位',
    'koueijob_dateline' => '发布时间',
    'kouei_job_title' => '求职数据管理',
    'kouei_job_search' => '求职数据搜索',
    'kouei_job_export_tips' => '<li>求职数据只显示部分重要数据，更多详情请搜索后点击查看，进入帖子查询即可。</li><li>导出求职数据信息最多支持 10000 条数据。导出的 .xls 文件可用 EXCEL 打开。</li>',
    'job_search_time' => '求职发表时间',
    'job_search_time_comment' => '格式 yyyy-mm-dd，不限制请输入 0',
    'koueijob_search_result' => '共搜索到<strong> {jobcount} </strong>名符合条件的数据',
    'koueijob_search_deleteall' => '删除搜索到的全部<strong> {jobcount} </strong>条数据',
    'koueijob_delete_thread' => '同时删除对应的帖子',
